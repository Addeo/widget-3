                ...
                if (XHR.status === 200 || XHR.status === 201) {
                    ...
                    if(myobj.success) {
                        setTimeout(() => {
                            ...
                            message.textContent = `Reset link sent to ${email.value}. Don't see it? Not in your spam folder? You might have signed up with a different email address. Please contact support@brightcall.ai in case of problems.`;
